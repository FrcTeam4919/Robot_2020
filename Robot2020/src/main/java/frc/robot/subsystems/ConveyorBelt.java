...
private static PWMVictorSPX conveyorController1;
    private static PWMVictorSPX conveyorController2;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    public ConveyorBelt() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        conveyorController1 = new PWMVictorSPX(7);
        addChild("ConveyorController1", conveyorController1);
        conveyorController1.setInverted(false);

        conveyorController2 = new PWMVictorSPX(8);
    ...
    public static void Cease(){
        ...
        conveyorController2.setSpeed(0);
    }
