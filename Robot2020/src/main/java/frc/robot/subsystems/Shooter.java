...
private PWMVictorSPX ballShooterController;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    public Shooter() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
ballShooterController = new PWMVictorSPX(8);
...
ballShooterController.setInverted(false);
    ...
    public void theViolenceHasEscalated(){
        ballShooterController.setSpeed(1.0);
    }
    public void theViolenceHasDeEscalated(){
