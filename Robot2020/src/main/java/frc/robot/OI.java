...
public class OI {
    ...
    public JoystickButton counterClockwiseSpinenr;
    ...
    joystick0 = new Joystick(0);
        ...
        winchRetract = JoystickButton(joystick0, 12);
        ...
        SmartDashboard.putData("WinchCommand", new WinchCommand());
        SmartDashboard.putData("TowerCommand", new TowerCommand());
        SmartDashboard.putData("ShooterCommand", new ShooterCommand());
        SmartDashboard.putData("BallCatcherCommand", new BallCatcherCommand());
        SmartDashboard.putData("DeployBallCatcherCommand", new DeployBallCatcherCommand());
        SmartDashboard.putData("ConveyorBeltCommand", new ConveyorBeltCommand());
        SmartDashboard.putData("ColorWheelSpinnerCommand", new ColorWheelSpinnerCommand());
        SmartDashboard.putData("DeploySpinnerCommand", new DeploySpinnerCommand());
